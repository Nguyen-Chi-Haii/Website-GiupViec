...
namespace API.Migrations
{
    ...
    [Migration("20260112081904_AddBookingIdToMessage")]
    partial class AddBookingIdToMessage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GiupViecAPI.Model.Domain.Message", b =>
                {
                    ...
                    b.HasOne("GiupViecAPI.Model.Domain.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GiupViecAPI.Model.Domain.User", "Sender")
                        .WithMany()
