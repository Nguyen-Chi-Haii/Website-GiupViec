...
@Component({
            ...
            <table class="data-table">
              ...
              <tbody>
                @for (user of filteredCustomers(); track user.id) {
                  ...
                  <tr>
                    <td colspan="7" class="empty-state">Không có khách hàng nào</td>
                  </tr>
                }
              </tbody>
            </table>
        ...
        <div class="modal-overlay" (click)="closeModal()">
          <div class="modal" (click)="$event.stopPropagation()">
            ...
            <div class="modal-body">
              <div class="form-grid">
                ...
                <div class="form-group">
                  <label>Email</label>
                  <input type="email" [(ngModel)]="formData.email" disabled />
                </div>
                <div class="form-group">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn-submit" (click)="saveUser()">Cập nhật</button>
            </div>
          </div>
        </div>
      }
  ...
  styles: [`
    ...
    .filter-input { padding: 0.5rem 1rem; border: 1px solid #e5e7eb; border-radius: 8px; font-size: 0.9rem; background: white; min-width: 250px; }
    ...
    .btn-submit { padding: 0.75rem 1.5rem; background: #13b9a5; color: #ffffff; border: none; border-radius: 8px; font-size: 0.9rem; font-weight: 600; cursor: pointer; }
    .btn-submit:hover { background: #0f9685; }
    .btn-outline { padding: 0.75rem 1.5rem; background: transparent; border: 1px solid #4b5563; border-radius: 8px; font-size: 0.9rem; font-weight: 500; cursor: pointer; color: #e5e7eb; }
